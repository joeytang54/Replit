...
public class Hw43 {
	...
	public static void main(String[] args) {
		 ...
		 * Example Output:
		 * 
		 * Input a number between 1-12 Input a number between 1-12 Invalid Invalid
		 * Example Output:
		 * 
		 * Input a number between 1-12 Input a number between 1-12 January
		 */

		
		System.out.println("Input a number betwee 1-12");
